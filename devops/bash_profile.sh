...
alias pg-cli="nerdctl run -e TZ=Asia/Shanghai -it --network postgres --rm amd64/postgres:14.5-alpine psql 'postgresql://vmi:vmi.%409_z!6@postgres-0:5432/vmi'"
...
alias mongo-cli="nerdctl run -e TZ=Asia/Shanghai -it --network mongo --rm amd64/mongo:6.0.1 mongosh --quiet 'mongodb://mongo-0:27017'"
...
alias redis-cli="nerdctl run -e TZ=Asia/Shanghai -it --network redis --rm redis:7.0.4-alpine redis-cli -h redis-0 -p 6379 -c -a '123456'"
